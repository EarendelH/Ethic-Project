...
The fairness gains are visible across the extended metrics. Predictive Parity decreases (0.1051 $\rightarrow$ 0.0971), NPV Equality becomes nearly equal (0.0335 $\rightarrow$ 0.0014), the AUC gap decreases (0.0531 $\rightarrow$ 0.0378), and Average Odds decreases (0.0620 $\rightarrow$ 0.0330). Disparate Impact also moves closer to parity, from 0.8886 to 0.9622. Across the complete evaluation set, 9 metrics improve in total: all 5 extended fairness metrics and 4 TFMA metrics (recall, true positive rate, false negative rate, and false omission rate).
